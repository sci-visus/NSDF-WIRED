...
We encourage you to explore the dataset on [UBC's website](https://firesmoke.ca/forecasts/) to further understand the dataset's use as described by UBC.
...
| BSC12CA12-01  | 20Z                                 |
| BSC18CA12-01  | 02Z                                 |
: UBC Smoke Forecast Data Download Parameters. All times are in UTC and the grid size is 12 km. {#tbl-access}
...
: Description of Attributes in NetCDF Files {#tbl-attrs}
...
**TODO USE netcdf_demo.ipynb**

```{python}
import xarray as xr

ds = xr.open_dataset("data_notebooks/data_source/dispersion.nc") # <1>
```
...
Now we know what data is available, how to download it, and how to extract information from the data to visualize it on a plot. We describe next how to extract data from these files to form one dataset.
